...
/**
 * Annotation to enable JOOQ repositories. Will scan the package of the annotated configuration class for Spring Data
...
public @interface EnableJooqRepositories {
	 ...
	 * {@link JooqRepositoryFactoryBean}.
	 * 
	 * @return
	 */
	Class<?> repositoryFactoryBeanClass() default JooqRepositoryFactoryBean.class;
